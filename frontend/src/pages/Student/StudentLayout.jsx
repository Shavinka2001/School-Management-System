...
function StudentLayout() {
    ...
    const navigation = [
        ...
        { name: 'Exams', to: '/student/exams', icon: ClipboardDocumentListIcon },
        { name: 'Assignments', to: '/student/assignments', icon: BookOpenIcon }
    ];
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center space-x-4">
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-lg font-semibold text-white">{user?.studentId || 'N/A'}</p>
                                                </div>
